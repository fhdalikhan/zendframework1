...
class Zend_Amf_Parse_Amf3_Deserializer extends Zend_Amf_Parse_Deserializer
{
    ...
    public function readInteger()
    {
        ...
        $result = 0;
        while ((0 != ($intReference & 0x80)) && $count < 4) {
            $result <<= 7;
    ...
    public function readObject()
    {
        ...
        $storedObject = 0 == ($traitsInfo & 0x01);
