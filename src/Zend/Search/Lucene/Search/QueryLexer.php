...
class Zend_Search_Lucene_Search_QueryLexer extends Zend_Search_Lucene_FSM
{
    ...
    {
        if (false !== strpos(self::QUERY_WHITE_SPACE_CHARS, $char)) {
            return self::IN_WHITE_SPACE;
        } elseif (false !== strpos(self::QUERY_SYNT_CHARS, $char)) {
            return self::IN_SYNT_CHAR;
        } elseif (false !== strpos(self::QUERY_MUTABLE_CHARS, $char)) {
            return self::IN_MUTABLE_CHAR;
        } elseif (false !== strpos(self::QUERY_LEXEMEMODIFIER_CHARS, $char)) {
            return self::IN_LEXEME_MODIFIER;
        } elseif (false !== strpos(self::QUERY_ASCIIDIGITS_CHARS, $char)) {
    ...
    public function addQuerySyntaxLexeme()
    {
        ...
        if (false !== strpos(self::QUERY_DOUBLECHARLEXEME_CHARS, $lexeme)) {
