...
class Zend_Search_Lucene implements Zend_Search_Lucene_Interface
{
    ...
    public static function getActualGeneration(Zend_Search_Lucene_Storage_Directory $directory)
    {
        ...
        try {
            ...
            if (false !== strpos($e->getMessage(), 'is not readable')) {
                try {
    ...
    public function __construct($directory = null, $create = false)
    {
        ...
        if ($create) {
            ...
            try {
                ...
                if (false === strpos($e->getMessage(), 'Can\'t obtain exclusive index lock')) {
                    throw new Zend_Search_Lucene_Exception($e->getMessage(), $e->getCode(), $e);
                } else {
    ...
    public function terms()
    {
        ...
        while (null !== ($segmentInfo = $segmentInfoQueue->pop())) {
