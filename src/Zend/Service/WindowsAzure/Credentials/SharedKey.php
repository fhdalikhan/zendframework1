    ...
    public function signRequestHeaders(
        ...
        if (!is_null($headers)) {
            foreach ($headers as $header => $value) {
                ...
                if (Zend_Service_WindowsAzure_Credentials_CredentialsAbstract::PREFIX_STORAGE_HEADER == substr($header, 0, strlen(Zend_Service_WindowsAzure_Credentials_CredentialsAbstract::PREFIX_STORAGE_HEADER))) {
        ...
        $contentLength = '';
        if (Zend_Http_Client::GET != strtoupper($httpVerb)
             && Zend_Http_Client::DELETE != strtoupper($httpVerb)
             && Zend_Http_Client::HEAD != strtoupper($httpVerb)) {
            $contentLength = 0;
